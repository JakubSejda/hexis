...
export function StagnationBadge({ weeksSincePr, suggestion }: Props) {
  ...
  return (
    <Tooltip content={hint}>
      <span
        tabIndex={0}
        className="bg-accent/10 text-accent focus-visible:ring-ring hud-clip-sm inline-flex items-center gap-1 px-2 py-0.5 text-xs focus-visible:ring-2 focus-visible:outline-none"
      >
